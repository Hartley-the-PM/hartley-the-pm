...
export const projectsData = [
  ...
  },
  {
    ...
    info2:
      'Hartley gathered all product related information and developed content criteria based on internal feedback, along with strategically choosing product images. He then worked with the global development and digital marketing teams to construct and design the layout of the platform.',
    url: '',
    repo: '', // if no repo, the button will not show up
  },
  {
    ...
    info: 'Hartley is diligently working on more exciting projects, product management articles, and case studies. Stay tuned to learn more and join the community!',
    info2: '',
    url: '',
    repo: '', // if no repo, the button will not show up
  },
